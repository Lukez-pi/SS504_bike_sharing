...
# Hour grouping by eye (most interpretable) - log transform count
# Adjusted R-squared: 0.83
summary(lm(log(cnt) ~ t2 + hum + wind_speed + weather_code + season + work + eye_hrs + work:eye_hrs, data = hour_data))
```
